...
Heatmap_decline <- data.frame(R0=rep(seq(1.5,5.0,by=0.5),times=8),Proportion=rep(seq(20,90,by=10),each=8),Value=as.vector(Heatmap),Min=as.vector(Heatmap_m),Max=as.vector(Heatmap_M))

write.xlsx(Heatmap_decline,"Heatmap_decline.xlsx")
